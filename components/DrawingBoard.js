...
DrawingBoard.Board = function(id, opts) {
	...
	if (this.opts.controlsPosition.indexOf("bottom") > -1) tpl += '<div class="drawing-board-controls hide"></div>';
	else tpl = '<div class="drawing-board-controls hide"></div>' + tpl;
...
DrawingBoard.Board.prototype = {
	...
	_onCanvasRightClick: function(e) {
